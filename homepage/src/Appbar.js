    ...
    <Paper className="Appbarstyle" zDepth={2} >
      <div className="containerdiv">
        <div className="buttons">
          <FlatButton label="home"  labelStyle={labelstyle} style={Buttonstyle} disableTouchRipple='true' hoverColor="#E6F7FE" icon={<ActionHome viewBox="0 0 28 28" color="#9E9E9E" />}  />                        
          <FlatButton label="notifs" labelStyle={labelstyle} style={Buttonstyle} disableTouchRipple='true' hoverColor="#E6F7FE" icon={<NotificationsIcon viewBox="0 0 28 28" color="#9E9E9E"/>} />             
          <FlatButton label="messages" labelStyle={labelstyle} style={Buttonstyle} disableTouchRipple='true' hoverColor="#E6F7FE" icon={<NotificationSms viewBox="0 0 28 28" color="#9E9E9E"/>} />           
        </div>
        <Avatar
